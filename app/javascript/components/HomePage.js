...
submitCard(e) {
  ...
  .then( response => {
    ...
    sentiments[response.data.sentiment].unshift( response.data );
      ...
      <div>
        ...
        >
          ...
          <form onSubmit={this.submitCard}>
            <h3>What happened?</h3>
            <textarea name="incident" className="form-control" onChange={ this.handleChange }></textarea>
            <h3>How do you feel about it?</h3>
            <textarea name="feeling" className="form-control" onChange={ this.handleChange }></textarea>
            <h3>What was your expectation?</h3>
            <textarea name="expectation" className="form-control" onChange={ this.handleChange }></textarea>
